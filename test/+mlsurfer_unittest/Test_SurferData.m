classdef Test_SurferData < matlab.unittest.TestCase
	...
	methods (Test) 
 		function test_thicknessOfOneBrain(this) 
 			import mlsurfer.*; 
            sdata = SurferData;            
            thickCortex = sdata.brain('subjectsDir', this.sessionPth, ...
                                      'Parameter', 'thickness', ...
                                      'Territory', this.TERRITORY);
            thickPca    = sdata.brain('subjectsDir', this.sessionPth, ...
                                      'Parameter', 'thickness', ...
                                      'Territory', 'pca');
 		...
 		function test_oefratioOfOneBrain(this) 
 			import mlsurfer.*; 
            sdata = SurferData;            
            oefCortex = sdata.brain('subjectsDir', this.sessionPth, ...
                                    'Parameter', 'oefnq_default_161616fwhh', ...
                                    'Territory', this.TERRITORY);
            oefCereb  = sdata.brain('subjectsDir', this.sessionPth, ...
                                    'Parameter', 'oefnq_default_161616fwhh', ...
                                    'Territory', 'cereb');
            oefPca    = sdata.brain('subjectsDir', this.sessionPth, ...
                                    'Parameter', 'oefnq_default_161616fwhh', ...
                                    'Territory', 'pca');
        ...
        function test_thicknessAll(this)
 			import mlsurfer.*; 
            sdata = SurferData;            
            thick = sdata.cohort('subjectsDir', this.subjectsDir, ...
                                 'Parameter', 'thickness', ...
                                 'Territory', this.TERRITORY);
        ...
        function test_thicknessIndexAll(this)
 			import mlsurfer.*; 
            sdata = SurferData;            
            thickIdx = sdata.cohortIndex('subjectsDir', this.subjectsDir, ...
                                         'Parameter', 'thickness', ...
                                         'Territory', this.TERRITORY);
        ...
        function test_oefratioAll(this)
 			import mlsurfer.*; 
            sdata = SurferData;            
            [oefCortex,idsCortex,sessCortex] = sdata.cohort('subjectsDir', this.subjectsDir, ...
                                               'Parameter', 'oefnq_default_161616fwhh', ...
                                               'Territory', this.TERRITORY);
            [oefCereb,idsCereb,sessCereb] = sdata.cohortCerebOefnq('subjectsDir', this.subjectsDir);
